...
public class PojoTiendaElectronica {
    ...
    public static void main(String[] args) throws Exception_Exception {
        try {
            ...
            System.out.println("Order created with orderId: " + otherOrderId);
            int otherDeliveryEstimate = createDeliverOrder(companyId, otherOrderId);
            System.out.println("Estimated delivery days for this order: " + otherDeliveryEstimate);
